...
%  keywords={break, case, catch, class,constructor, continue, debugger, default, delete, do, lse,export, false, finally, for, function, if,implements, in, instanceof, new, null, return, witch,static, this, throw, true, try, typeof, var, void, while, with},
%  morecomment=[l]{//},
%  morecomment=[s]{/*}{*/},
%  morestring=[b]',
%  morestring=[b]",
...
\section{Full API Specification}\label{fullApiSpec}
...
\lstinputlisting[ language=Java,tabsize=2 ]{Listings/Testing/RemoveNodeReferenceServiceTest.java}
...
\lstinputlisting[showstringspaces=false,language=Xtend, tabsize=2 ]{Listings/Testing/EditorLanguageParsingTest.xtend}
...
\lstinputlisting[ language=Xtext, tabsize=2 ]{Listings/EditorLanguage.xtext}

\section{Expression Language Definition}\label{expressionLanguageDef}
\subsection{Xtext Grammar Specification}
\lstinputlisting[ language=Xtext, tabsize=2 ]{Listings/Arithmetic/Arithmetic.xtext}

\subsection{Projections (.editor file)}\label{expressionLanguageDefEditor}
\lstinputlisting[ language=Editor, tabsize=2 ]{Listings/Arithmetic/Projections.editor}

\section{Questionnaire Language Definition}\label{questionnaireLanguageDef}

\subsection{Xtext Grammar Specification}
\lstinputlisting[ language=Xtext, tabsize=2 ]{Listings/Question/Q.xtext}

\subsection{Projections (.editor file)}\label{questionnaireLanguageDefEditor}
\lstinputlisting[ language=Editor, tabsize=2 ]{Listings/Question/Projections.editor}


\section{PasGraph Language Definition}\label{pascalLanguageDef}

\subsection{Xtext Grammar Specification}
\lstinputlisting[ language=Xtext, tabsize=2 ]{Listings/Graph/Graph.xtext}

\subsection{Projections (.editor file)}\label{pascalLanguageDefEditor}
\lstinputlisting[ language=Editor, tabsize=2 ]{Listings/Graph/Projections.editor}



\includepdf[frame=true,offset= 0 -1cm, pages=1,scale=.73,pagecommand=\section{Questionnaire Evaluation Materials}\label{questionnaireEval} \subsection{Training Material}]{./Appendix/QuestionnaireTraining2.pdf}
\includepdf[frame=true,pages=2-,scale=.8,pagecommand={\thispagestyle{plain}}]{./Appendix/QuestionnaireTraining2.pdf}

\includepdf[frame=true,offset= 0 -0.6cm,pages=1,scale=.75,pagecommand=\subsection{Task Sheet}]{./Appendix/QuestionnaireTasks.pdf}
\includepdf[frame=true,pages=2-,scale=.8,pagecommand={\thispagestyle{plain}}]{./Appendix/QuestionnaireTasks.pdf}

\includepdf[frame=true,offset= 0 -0.6cm,pages=-,scale=.75,pagecommand=\subsection{Interview Script}]{./Appendix/InterviewQuestions.pdf}
