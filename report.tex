...
\\
To those without prior experience, traditional textually based programming can seem alienating and complex \todo{ see if source exists} making it difficult for language designers to target such users.
\\
\\
