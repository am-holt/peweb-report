...
\\
\\
An instance of a program ultimately creates a tree like structure in the abstract syntax, with each node in the tree representing a concept in the language such as a function call or a binary operation, this is called an Abstract Syntax Tree.\todo{diagram}
