...
\subsection{Xtext}
\todo{TODO}
%Textual language workbench
%Eclipse Plugin
%Grammar Language
%Standard generation process using MWE2
%Web editor generation
%Generation process uses EMF
\subsection{Xtend}
\todo{TODO}
%A modified version of java used by XText
\subsection{MPS}
\todo{TODO}
%Language workbench which creates projectional editors
%Generation process -> grammar definition & Editor definition
%Editor Language discussion from 5 here?
%Generated editors?
\subsection{Abstract Syntax Tree}
\todo{TODO}
%Overview, structure of programming language
%What is? 3 formalisations: EMF, etc. from DSL engineering book
%Summary of all 3
\subsection{EMF}
\todo{TODO}
...
\subsection{MWE2}
\todo{TODO}
%What actually is MWE2? I have no clue.
%
%
%Overview
%
