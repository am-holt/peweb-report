...
\item Cross-reference: References to nodes which exist independently of this node. An example in a GPL may be a Function-Call node referencing the relevant Function-Definition node. 
\end{itemize}
